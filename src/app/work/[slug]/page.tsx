...
const sectionLabels: Record<string, string> = {
  problem: "Problem",
  productThinking: "Product decisions",
  uiArchitecture: "UI system",
  technicalApproach: "Engineering",
  ...
  return (
    <main className="case-study">
      <header className="case-nav">
        <Link href="/#work"><ArrowLeft size={15} /> Back to work</Link>
        <Link href="/">StudioWolfCode</Link>
      </header>

      <section className="case-hero">
        <p className="case-kicker">{project.status === "in-progress" ? "currently building" : "prototype"} · {project.role}</p>
        <h1>{project.title}</h1>
